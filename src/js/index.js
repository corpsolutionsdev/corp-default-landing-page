...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const to = 'sac_corpsolutions@hotmail.com'; 
            const subject = encodeURIComponent('Contato pelo site - Corp IT Solutions');
            ...
            const mailto_link = 'mailto:'+to+'?subject='+subject+'&body='+body;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    contactOptions.forEach(option => {
        option.onclick = function(e) {
            ...
            const message = encodeURIComponent(`Olá, Corp IT Solutions. Gostaria de mais informações sobre seus produtos ou serviços. Podem me ajudar?`);
